...
For every node with at least one immediate child, the gcd of the values of all immediate children is equal to the value of the node. The total sum of the values of all nodes should be minimum.
